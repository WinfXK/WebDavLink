...
public class PropertyUtils {
	...
	PropertyUtils(PlatformFeatureDetector platformFeatureDetector) {
		...
		/*
		 * Android lacks much of java.beans (including the Introspector class, used
		 * here), because java.beans classes tend to rely on java.awt, which isn't
		 * supported in the Android SDK. That means we have to fall back on FIELD access
		 * only when SnakeYAML is running on the Android Runtime.
		 */
	 ...
	 *
	 * @param skipMissingProperties true if missing properties should be skipped,
	 *                              false otherwise.
	 */
