...
public class Representer extends SafeRepresenter {
	...
	/**
	 * Tag logic: - explicit root tag is set in serializer - if there is a
	 * predefined class tag it is used - a global tag with class name is always used
	 * as tag. The JavaBean parent of the specified JavaBean may set another tag
	 * (tag:yaml.org,2002:map) when the property class is the same as runtime class
	 *
	...
	/**
	 * Remove redundant global tag for a type safe (generic) collection if it is the
	 * same as defined by the JavaBean property
	 *
	...
	/**
	 * Get JavaBean properties to be serialised. The order is respected. This method
	 * may be overridden to provide custom property selection or order.
	 *
