...
public class MethodProperty extends GenericProperty {
	...
	private static Type discoverGenericType(PropertyDescriptor property) {
		 ...
		 * IndexedPropertyDescriptor and it has only IndexedGetter/Setter. ATM we simply
		 * skip type discovery.
		 */
		return null;
	}
	...
	/**
	 * Returns the annotations that are present on read and write methods of this
	 * property or empty {@code List} if there're no annotations.
	 *
	...
	/**
	 * Returns property's annotation for the given type or {@code null} if it's not
	 * present. If the annotation is present on both read and write methods, the
	 * annotation on read method takes precedence.
	 *
	 * @param annotationType the type of the annotation to be returned
	 * @return property's annotation for the given type or {@code null} if it's not
	 *         present
	 */
	@Override
