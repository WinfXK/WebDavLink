...
public class ProgressWheel extends View {
	...
	/**
	 * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the
	 * view, because this method is called after measuring the dimensions of
	...
	/**
	 * Set the progress to a specific value, the bar will be set instantly to that
	 * value
	 *
	...
	/**
	 * @return the base spinning speed, in full circle turns per second (1.0 equals
	...
	/**
	 * Sets the base spinning speed, in full circle turns per second (1.0 equals on
	 * full turn in one second), this value also is applied for the smoothness when
	 * setting a progress
	 *
	...
	public interface ProgressCallback {
		/**
		 * Method to call when the progress reaches a value in order to avoid float
		 * precision issues, the progress is rounded to a float with two decimals.
		 *
		 * In indeterminate mode, the callback is called each time the wheel completes
		 * an animation cycle, with, the progress value is -1.0f
		 *
